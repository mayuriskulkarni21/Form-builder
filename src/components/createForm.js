        ...
        return (
            <Form className="create-form">
                <FormGroup controlId="formBasicEmail">
                    ...
                    {(this.state.error === false && this.state.name !== '') &&
                        <p className="text-success">Form saved successfully!</p>}
                    {(this.state.addQuestion === true && this.state.name !== '' && this.state.error !== false) &&
                ...
                <Button className="buttons mt-2 p-1 adjustWidth btn-info" onClick={(e) => this.handleClear(e)} disabled={this.state.name.length === 0}>clear</Button>
